...
Samotné 2D rozpoznávání se navíc v praxi často blíží limitům daným kvalitou trénovacích dat a anotací; další zvýšení robustnosti proto typicky vyžaduje využít silnější priory a 3D omezení \cite{moravkova2025,wang2024prompthmr}.
...
Příklad outputu je v příloze \ref{app:overview-434204} nebo na repozitáři pod \code{documentation/img/output/}
